...
public:
     ...
     */
    virtual FeedReply<FinancialInstrument> resolveSymbol(const std::string& symbol) = 0;
    
    /**
     * Resolves the quote for the financial instrument identified by the symbol.
     */
    virtual FeedReply<Quote> resolveQuote(const std::string& symbol) = 0;
    
    /**
     * Searches possible financial instruments by keywords.
     */
    virtual FeedReply<std::vector<FinancialInstrument>> searchSymbols(const std::string& keyword) = 0;
};
